      ...
      >
        <div className="absolute top-16 left-3 md:top-20 md:left-20 px-3 md:px-10 lg:px-14 w-full lg:w-1/2 text-white animate-slide">
          ...
          <div className="ml-5 md:ml-3 lg:ml-0 ">
            <button className="bg-white text-green-400 py-2 text-lg px-8 font-semibold rounded-lg hover:bg-transparent hover:border hover:border-white hover:text-white duration-200">
              Read More
            </button>
          </div>
        </div>
